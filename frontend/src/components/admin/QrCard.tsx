...
import { Download, QrCode, UtensilsCrossed, ExternalLink } from 'lucide-react';
...
export const QrCard: React.FC<QrCardProps> = ({ table, restaurant }) => {
  ...
  return (
    <div
      ref={cardRef}
      className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-6 shadow-md hover:shadow-xl transition-all flex flex-col items-center text-center space-y-4"
    >
      {/* Table Badge & Occupancy */}
      ...
      {/* QR Code Container */}
      <div className="p-4 rounded-2xl bg-white border-2 border-dashed border-brand-500/40 shadow-sm flex flex-col items-center">
