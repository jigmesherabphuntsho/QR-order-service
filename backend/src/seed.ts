...
async function main() {
      ...
      items: [
        {
          ...
          isAvailable: true, isTodaySpecial: true, sortOrder: 1,
        },
        {
          ...
          isAvailable: true, isTodaySpecial: false, sortOrder: 2,
        },
        {
          ...
          isAvailable: true, isTodaySpecial: true, sortOrder: 3,
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          isAvailable: true, isTodaySpecial: true, sortOrder: 2,
        },
        {
          ...
          isAvailable: true, isTodaySpecial: false, sortOrder: 3,
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          isAvailable: false, isTodaySpecial: false, sortOrder: 3,
        },
      ],
    },
    {
  ...
  const fries = await prisma.menuItem.findFirst({ where: { name: { contains: 'Truffle Parmesan' } } });
